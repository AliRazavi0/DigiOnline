                        ...
                        <div class="col-lg-7 col-md-7 col-xs-12 mx-auto">
                            <div class="account-box">
                                ...
                                <div class="account-box-headline">
                                    <a href="login.html" class="login-ds active-account">ورود</a>
                                    <a href="register.html" class="register-ds">ثبت نام</a>
                                </div>
                                <div class="account-box-content">
                                    <form action="#" class="form-account">
                                        <div class="form-account-title">
                                            <label for="email-phone">ایمیل / شماره موبایل</label>
                                            <input type="text" class="number-email-input" id="email-phone" placeholder="ایمیل یا شماره موبایل خود را وارد نمایید">
                                            <span class="mdi mdi-account-outline"></span>
                                        </div>
                                        <div class="form-account-title">
                                            <label for="password">رمز عبور</label>
                                            <input type="password" class="password-input" placeholder="رمز عبور خود را وارد نمایید">
