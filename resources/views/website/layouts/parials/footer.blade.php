    ...
    <article class="container-main">
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-12 pull-right">
                        <nav class="footer-links-col">
                            <div class="headline-links mb-3">
                                <a href="#">
                                    راهنمای خرید از {{config('app.name')}}
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-12 pull-right">
                        <nav class="footer-links-col">
                            ...
                            <ul class="footer-links-ul">
                                <li>
                                    <a href="#">
                                        اتاق خبر  {{config('app.name')}}
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        فروش در  {{config('app.name')}}
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                ...
                                <li>
                                    <a href="#">
                                        تماس با  {{config('app.name')}}
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        درباره ما  {{config('app.name')}}
                                    </a>
                                </li>
                            </ul>
                        </nav>
            ...
            <div class="col-lg-4 col-md-4 col-xs-12 pull-left">
                <div class="footer-form">
                    <form action="#" class="form-newsletter mb-4 mt-4">
                        <fieldset>
                            <span class="form-newsletter-title">از تخفیف‌ها و جدیدترین‌های {{config('app.name')}} باخبرشوید:</span>
                    ...
                    <div class="footer-community">
                        <div class="footer-social mb-4 mt-4">
                            <span> {{config('app.name')}}  را در شبکه‌های اجتماعی دنبال کنید:</span>
                ...
                <div class="col-xs-8 col-md-8 col-xs-12 pull-right">
                    <div class="footer-content">
                        <article class="footer-seo mt-3">
                            <h1>فروشگاه اینترنتی {{config('app.name')}}، بررسی، انتخاب و خرید آنلاین</h1>
                            <p> {{config('app.name')}}  به عنوان یکی از قدیمی‌ترین فروشگاه های اینترنتی با بیش از یک دهه تجربه، با
                                پایبندی به سه اصل، پرداخت در محل، 7 روز ضمانت بازگشت کالا و تضمین اصل‌بودن کالا موفق شده
                                تا همگام با فروشگاه‌های معتبر جهان، به بزرگ‌ترین فروشگاه اینترنتی ایران تبدیل شود. به
                                محض ورود به سایت  {{config('app.name')}}  با دنیایی از کالا رو به رو می‌شوید! هر آنچه که نیاز دارید و
        ...
        <div class="footer-copyright">
            <div class="footer-copyright-text">
                استفاده از مطالب فروشگاه اینترنتی  {{config('app.name')}}  فقط برای مقاصد غیرتجاری و با ذکر منبع
                بلامانع است. کلیه حقوق این سایت متعلق به شرکت نوآوران فن آوازه (فروشگاه آنلاین  {{config('app.name')}} ) می‌باشد.
            </div>
        </div>
    </article>
</footer>
